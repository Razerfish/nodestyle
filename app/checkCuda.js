...
const torchTools = require('./torchTools');
...
function checkCuda() {
    return new Promise((resolve, reject) => {
        ...
        const cudaProcess = execFile(torchTools.getTorchPath(), ["check_cuda"]);
...
function checkCudaSync(timeout = 10000) {
    ...
    let cuda = execFileSync(torchTools.getTorchPath(), ["check_cuda"], {
        timeout: timeout
    });
